...
const Card = ({title}) => {
  return (
    <div className='Card text-white p-4 m-2 rounded-lg grid grid-cols-2 items-center'>
        <div className="text">
            ...
            <button className='btn bg-black text-white p-4 rounded-lg'>Read More</button>
        </div>
